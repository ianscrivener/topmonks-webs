...
export default class CloudinaryAutoFormatAudit extends Audit {
  static get meta() {
    return {
      ...
      description:
        "Auto-format of Cloudinary images helps to deliver the best" +
  ...
  static audit(artifacts) {
    ...
    return {
      score: Number(passed),
      warnings: noAutoFormat.map(
        x =>
          `A Cloudinary image "${x.src}" was found, but "f_auto" transformation is missing.`
      )
    };
  }
}
